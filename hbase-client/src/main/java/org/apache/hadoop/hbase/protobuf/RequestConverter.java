...
//Start utilities for Admin
 ...
 public static FlushRegionRequest
   ...
   * New
   */
  public static FlushIndexRegionRequest
  buildFlushIndexRegionRequest(final byte[] regionName) {
    return buildIndexFlushRegionRequest(regionName, false);
  }
   ...
   */
  public static FlushIndexRegionRequest
  buildIndexFlushRegionRequest(final byte[] regionName, boolean writeFlushWALMarker) {
    FlushIndexRegionRequest.Builder builder = FlushIndexRegionRequest.newBuilder();
    RegionSpecifier region = buildRegionSpecifier(
            RegionSpecifierType.REGION_NAME, regionName);
    builder.setRegion(region);
    builder.setWriteFlushWalMarker(writeFlushWALMarker);
