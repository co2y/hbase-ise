...
/**
 * Created by co2y on 15/10/2017.
 */
/**
 * This manager class handles flushing of the regions for table on a {@link HRegionServer}.
 */
@InterfaceAudience.LimitedPrivate(HBaseInterfaceAudience.CONFIG)
public class RegionServerFlushIndexTableProcedureManager extends RegionServerProcedureManager {
    private static final Log LOG = LogFactory.getLog(RegionServerFlushIndexTableProcedureManager.class);
     ...
     */
    RegionServerFlushIndexTableProcedureManager(Configuration conf, HRegionServer server,
    ...
    public RegionServerFlushIndexTableProcedureManager() {}
    ...
    public Subprocedure buildSubprocedure(String table) {
        ...
        FlushIndexTableSubprocedurePool taskManager =
                new FlushIndexTableSubprocedurePool(rss.getServerName().toString(), conf, rss);
        return new FlushIndexTableSubprocedure(member, exnDispatcher, wakeMillis,
    ...
    public class FlushIndexTableSubprocedureBuilder implements SubprocedureFactory {

        @Override
        public Subprocedure buildSubprocedure(String name, byte[] data) {
            // The name of the procedure instance from the master is the table name.
            return RegionServerFlushIndexTableProcedureManager.this.buildSubprocedure(name);
        }

    }

    /**
     * We use the FlushIndexTableSubprocedurePool, a class specific thread pool instead of
     ...
     * failures.
     */
    static class FlushIndexTableSubprocedurePool {
        ...
        FlushIndexTableSubprocedurePool(String name, Configuration conf, Abortable abortable) {
            this.abortable = abortable;
            // configure the executor service
            long keepAlive = conf.getLong(
                    RegionServerFlushIndexTableProcedureManager.FLUSH_TIMEOUT_MILLIS_KEY,
                    RegionServerFlushIndexTableProcedureManager.FLUSH_TIMEOUT_MILLIS_DEFAULT);
    ...
    public void initialize(RegionServerServices rss) throws KeeperException {
        ...
        this.memberRpcs = new ZKProcedureMemberRpcs(zkw,
                MasterFlushIndexTableProcedureManager.FLUSH_TABLE_PROCEDURE_SIGNATURE);
        ...
        ThreadPoolExecutor pool = ProcedureMember.defaultPool(rss.getServerName().toString(),
                opThreads, keepAlive);
        this.member = new ProcedureMember(memberRpcs, pool, new FlushIndexTableSubprocedureBuilder());
    }

    @Override
    public String getProcedureSignature() {
        return MasterFlushIndexTableProcedureManager.FLUSH_TABLE_PROCEDURE_SIGNATURE;
    }
