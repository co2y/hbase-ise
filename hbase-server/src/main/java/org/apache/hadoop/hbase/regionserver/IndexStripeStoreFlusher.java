...
public class IndexStripeStoreFlusher extends StripeStoreFlusher {
    ...
    public IndexStripeStoreFlusher(Configuration conf, Store store, StripeCompactionPolicy policy, StripeStoreFileManager stripes) {
    ...
    public List<Path> flushSnapshot(MemStoreSnapshot snapshot, long cacheFlushSeqNum,
        ...
        return flushIndexSnapshot(snapshot, cacheFlushSeqNum, status);
    }
