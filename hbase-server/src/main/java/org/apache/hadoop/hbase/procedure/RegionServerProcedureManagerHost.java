...
import org.apache.hadoop.hbase.procedure.flush.RegionServerFlushIndexTableProcedureManager;
...
public class RegionServerProcedureManagerHost extends
  ...
  public void loadProcedures(Configuration conf) {
    ...
    procedures.add(new RegionServerFlushIndexTableProcedureManager());
  }
