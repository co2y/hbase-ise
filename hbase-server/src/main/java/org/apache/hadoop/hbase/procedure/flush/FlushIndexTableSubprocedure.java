...
import org.apache.hadoop.hbase.procedure.flush.RegionServerFlushIndexTableProcedureManager.FlushIndexTableSubprocedurePool;
...
public class FlushIndexTableSubprocedure extends Subprocedure {
    private static final Log LOG = LogFactory.getLog(FlushIndexTableSubprocedure.class);

    private final String table;
    private final List<Region> regions;
    private final FlushIndexTableSubprocedurePool taskManager;

    public FlushIndexTableSubprocedure(ProcedureMember member,
