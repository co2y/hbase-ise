...
public class StripeCompactionPolicy extends CompactionPolicy {
  ...
  // change from private to protected by co2y 2017-12-1
  protected Pair<Long, Integer> estimateTargetKvs(Collection<StoreFile> files, double splitCount) {
   ...
   */
  // change from private to protected by co2y 2017-12-1
  protected static class BoundaryStripeCompactionRequest extends StripeCompactionRequest {
   ...
   */
  // change from private to protected by co2y 2017-12-1
  protected static class SplitStripeCompactionRequest extends StripeCompactionRequest {
