...
public class StoreScanner extends NonReversedNonLazyKeyValueScanner
   ...
   * New
   */
  public StoreScanner(HStore store, ScanInfo scanInfo,
    ...
    this(store, scanInfo, scanners, ScanType.INDEX_DELETES, smallestReadPoint,
            earliestPutTs, dropDeletesFromRow, dropDeletesToRow);
      ...
      switch (qcode) {
        ...
        case SEEK_NEXT_COL:
          if (this.scanType == ScanType.INDEX_DELETES) {
            byte[] dataKeyTodels = CellUtil.cloneRow(cell);
