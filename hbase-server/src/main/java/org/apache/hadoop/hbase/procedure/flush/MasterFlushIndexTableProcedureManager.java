...
public class MasterFlushIndexTableProcedureManager extends MasterProcedureManager {

    public static final String FLUSH_TABLE_PROCEDURE_SIGNATURE = "flush-index-table-proc";
    ...
    private static final Log LOG = LogFactory.getLog(MasterFlushIndexTableProcedureManager.class);
    ...
    public MasterFlushIndexTableProcedureManager() {
    }
