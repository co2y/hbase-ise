...
ClientProtos.ClientService.BlockingInterface, RegionServerServices {
  ...
  @Override
  public AdminProtos.FlushIndexRegionResponse flushIndexRegion(RpcController controller, AdminProtos.FlushIndexRegionRequest request) throws ServiceException {
    return null;
  }
